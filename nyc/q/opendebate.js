(function($, obviel) {
  ...
  od.init = function(question_page, vote_page, 
                     question_proxy, timeline_proxy, 
...
//        rx = /^(\d{4}\-\d\d\-\d\d([tT][\d:\.]*)?)([zZ]|([+\-])(\d{4}))?$/,
  ...
  obviel.view({
    iface: "recognized_user",
    obvtUrl: "templates/recognized_user.obvt.html"
  });
  obviel.view({
    iface: "question",
    obvtUrl: "templates/question.obvt.html"
  });

  var map_popup_template = null;
  $.ajax("templates/question_in_map.hbars.html", {
  ...
  obviel.view({
    ...
    obvtUrl: "templates/question_detail.obvt.html"
  });
  obviel.view({
    iface: "empty",
    "html": ""
  ...
  obviel.view({
    iface: "list",
    obvtUrl: "templates/list.obvt.html"
  });
  obviel.view({
    iface: "searchList",
    obvtUrl: "templates/search.obvt.html"
  });
  obviel.view({
    iface: "timeline",
    obvtUrl: "templates/activity.obvt.html"
  });
  obviel.view({
    iface: "timeline_question",
    obvtUrl: "templates/activity_question.obvt.html"
  });
  obviel.view({
    iface: "timeline_vote",
    obvtUrl: "templates/activity_vote.obvt.html"
  });
